        ...
        <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
          <div>
            ...
            <div className="flex mt-6  space-x-6 text-white">
              ...
              <a
                href="https://www.instagram.com/quillessay_?igsh=MjhpYTAwcHh6YXFq"
                className="hover:opacity-75"
                target="_blank"
                rel="noreferrer"
              >
          ...
          <div className="grid grid-cols-1 gap-8 lg:col-span-2 sm:grid-cols-2 lg:grid-cols-3">
            ...
            <div>
              ...
              <nav className="flex flex-col mt-4 space-y-2 text-sm text-white">
                ...
                <a
                  href="mailto:support@quillessay.com"
                  className="hover:opacity-75"
                >
                  Email :- support@quillessay.com
                </a>
                <a href="+44 1268230296" className="hover:opacity-75">
                  Phone :- +44 1268230296
                </a>
