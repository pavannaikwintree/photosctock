...
const HomePage = () => {
    ...
    return (
        <>
            <Hero />
            {/* Image Grid */}
            <div className="h-[100px] p-0 banner-promo-bg flex flex-col justify-center items-center">
                <div className="flex flex-col md:flex-row max-w-4xl justify-center items-center gap-3">
